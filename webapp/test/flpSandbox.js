		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comnttsmuserproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnttsmuserproject-display": {
								"semanticObject": "comnttsmuserproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ntt.sm.userproject",
									"url": sap.ui.require.toUrl("com/ntt/sm/userproject")
								}
							}
						}
					}
